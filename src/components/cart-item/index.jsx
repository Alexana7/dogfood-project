...
// import './styles.css';
import {ReactComponent as TrashIcon} from './image/trash.svg';
...
import { removeProductCart, changeCartQuantity, incrementQuantity, decrementQuantity } from '../../storage/cart/cart-slice';
  ...
  return (
    <>
      <div className={s.cartItem}>
        ...
        {!isGift && <div className={s.cartPrice}>
          <ProductPrice price={price} discount={discount} type="big" align='right' /></div>
        }
        {!isGift && 
